...
export const fileRegistryAbi = [
  ...
  {
    type: 'function',
    inputs: [{ name: 'uploader', internalType: 'address', type: 'address' }],
    name: 'addUploader',
    outputs: [],
    stateMutability: 'nonpayable',
  },
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: '_fileName', internalType: 'string', type: 'string' },
    ],
    name: 'registerFile',
    outputs: [],
    stateMutability: 'nonpayable',
...
export const groth16VerifierAbi = [
  {
    ...
    inputs: [
      ...
      { name: '_pB', internalType: 'uint256[2][2]', type: 'uint256[2][2]' },
      { name: '_pC', internalType: 'uint256[2]', type: 'uint256[2]' },
      { name: '_pubSignals', internalType: 'uint256[1]', type: 'uint256[1]' },
    ],
    name: 'verifyProof',
    outputs: [{ name: '', internalType: 'bool', type: 'bool' }],
    stateMutability: 'view',
